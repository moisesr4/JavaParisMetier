...
//		testConstructeurSiteDeParisMetier(); //check
//	   	testValiditePasswordGestionnaire();  //check
//	   	testInscrireDesinscrireJoueur();     //check
//		testCrediterDebiterJoueur();
//		testAjouterCompetition();			 //check
//		testMiserVainqueur();
//		testSolderVainqueur();
//		testConsulterCompetitions();		//Add exceptions
		testConsulterCompetiteurs();		//Add exceptions
//		testConsulterJoueurs();				//Add exceptions
